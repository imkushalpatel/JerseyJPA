...
public class PersistenceProperties {
	 ...
	 *            properties overriding default properties
	 * @param entityClasses
	 *            entity classes to load, not listed in persistence.xml or
	 *            orm.xml
	 * @return persistence properties for the given provider
	 */
	public static Properties createPropertiesForProvider(final String providerName,
			final Properties overridingProperties, final List<?> entityClasses) {
		...
		if (ECLIPSELINK.equals(providerName)) {
			...
			// "create-or-extend-tables", "drop-and-create-tables", "none"
			// See:
			// http://eclipse.org/eclipselink/documentation/2.5/jpa/extensions/p_ddl_generation.htm
			properties.put("eclipselink.ddl-generation", "drop-and-create-tables"); //
			properties.put("eclipselink.ddl-generation.output-mode", "database");
			properties.put("eclipselink.logging.level", "OFF"); // OFF, SEVERE,
																// WARNING,
																// INFO, CONFIG,
																// FINE, FINER,
																// FINEST, ALL
			...
			// EL optimization, see:
			// http://java-persistence-performance.blogspot.no/2011/06/how-to-improve-jpa-performance-by-1825.html
			 ...
			 * p.put("net.sf.ehcache.configurationResourceName",
			 * "/ehcache.xml");
			 */
