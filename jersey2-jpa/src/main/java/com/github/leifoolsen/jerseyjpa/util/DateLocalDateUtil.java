...
public class DateLocalDateUtil {
	...
	/**
	 * Calls {@link #dateToLocalDateTime(Date, ZoneId)} with the system default
	 * time zone.
	 *
	 * @param date
	 * @return
	...
	public static LocalDateTime dateToLocalDateTime(java.util.Date date, ZoneId zone) {
		...
		return date instanceof java.sql.Timestamp ? ((java.sql.Timestamp) date).toLocalDateTime()
	...
	/**
	 * Creates a {@link java.util.Date} from various date objects. Currently
	 * supports:
	 * <ul>
	 ...
	 *             if the date parameter is not supported
	 */
