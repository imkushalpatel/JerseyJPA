...
public class DomainPopulator {
	...
	public static List<Book> getBooks(final Map<String, Publisher> publishers) {
		...
		return Arrays.asList(
				Book.with("9781846883668").title("Travelling to Infinity: The True Story").author("Hawking, Jane")
						.publisher(publishers.get(ALMA_BOOKS)).published(LocalDate.of(2014, Month.NOVEMBER, 18))
				...
				Book.with("9788204094261").title("Superstjernen Stephen Hawking: biografi")
						.author("Gribbin, John; White, Michael").publisher(publishers.get(DAMM))
						.published(LocalDate.of(2014, Month.JANUARY, 1))
						.translator("Larsen, Anne Kirsti Solheim; Larsen, Finn B.")
						.summary(
								"Boka forteller om livet til vitenskapsmannen Stephen Hawking. Boka gir ett innblikk i både "
				...
				Book.with("9781118175392").title("Alone in the Universe: Why Our Planet Is Unique")
						.author("Gribbin, John").publisher(publishers.get(TURNER))
						.published(LocalDate.of(2011, Month.JANUARY, 1))
				...
				Book.with("9780752495620").title("Guide to Middle Earth: Tolkien and The Lord of the Rings")
						.author("Duriez, Colin").publisher(publishers.get(HISTORY_PRESS))
						.published(LocalDate.of(2013, Month.JANUARY, 1))
						.summary("An illuminating guide to Middle-earth and the man who created it.").build(),

				Book.with("9788253019727").title("Verdens duer").author("Steinbeck, John")
						.publisher(publishers.get(PAX)).published(LocalDate.of(1998, Month.JANUARY, 1))
						.translator("Omre, Arthur")
						.summary(
								"I 1939 (på norsk i 1940) kom denne romanen som slo fast at Steinbeck var en av mestrene "
				...
				Book.with("9788205478428") // 9788205418820 - 9788205478428
						.title("Gravrøys").author("Theorin, Johan").publisher(publishers.get(GYLDENDAL))
						.published(LocalDate.of(2014, Month.JANUARY, 1)).translator("Bolstad, Kari")
				...
				Book.with("9788205478336").title("Kuppet: på innsiden av Norges mektigste mafiafamilie")
						.author("Aass, Hans Petter; Widerøe, Rolf J.").publisher(publishers.get(GYLDENDAL))
						.published(LocalDate.of(2015, Month.JANUARY, 1))
						.summary(
								"En ny, knallsterk dokumentar fra forfatterne av bestselgerne Dødsranet og Krigshelten. "
				...
				Book.with("9788205418820")
						...
						.author("Svensson, Lars").publisher(publishers.get(GYLDENDAL))
						.published(LocalDate.of(2011, Month.JANUARY, 1))
						.translator("Sandvik, Jostein; Syvertsen, Per Ole")
						.summary(
								"Verdens beste fuglebok i ny feltutgave! Gyldendals store fugleguide er markedets mest "
				...
				Book.with("9781784700089").title("Alan Turing: The Enigma").author("Hodges, Andrew")
						.publisher(publishers.get(VINTAGE_UK)).published(LocalDate.of(2014, Month.NOVEMBER, 13))
				...
				Book.with("9780099554486").title("The Lives of Others").author("Mukherjee, Neel")
						.publisher(publishers.get(VINTAGE)).published(LocalDate.of(2015, Month.JANUARY, 8))
				...
				Book.with("9788202148683").title("Fisken").author("Loe, Erlend").publisher(publishers.get(CAPPELEN))
						.published(LocalDate.of(1994, Month.JANUARY, 1))
				...
				Book.with("9788202244699").title("Rumpemelk fra Afrika").author("Loe, Erlend")
						.publisher(publishers.get(CAPPELEN_DAMM)).published(LocalDate.of(2012, Month.SEPTEMBER, 1))
				...
				Book.with("9788202425975").title("Doppler").author("Loe, Erlend")
						.publisher(publishers.get(CAPPELEN_DAMM)).published(LocalDate.of(2013, Month.OCTOBER, 1))
				...
				Book.with("9788202426378").title("Naiv. Super").author("Loe, Erlend")
						.publisher(publishers.get(CAPPELEN_DAMM)).published(LocalDate.of(2013, Month.JANUARY, 1))
				...
				Book.with("9788202365387").title("Fonk").author("Loe, Erlend").publisher(publishers.get(CAPPELEN_DAMM))
						.published(LocalDate.of(2011, Month.OCTOBER, 1))
						.summary(
								"Mens Fvonk står i disse, og andre, tanker ruller en helt ren sort bil, tyskprodusert, "
				...
				Book.with("9781447268970").title("Station Eleven").author("St. John Mandel, Emily")
						.publisher(publishers.get(PICADOR)).published(LocalDate.of(2015, Month.JANUARY, 1))
				...
				Book.with("9781447279402").title("The Guest Cat").author("Hiraide, Takashi")
						.publisher(publishers.get(PICADOR)).published(LocalDate.of(2014, Month.SEPTEMBER, 25))
				...
				Book.with("9780241971987").title("Little Failure").author("Shteyngart, Gary")
						.publisher(publishers.get(PENGUIN)).published(LocalDate.of(2014, Month.SEPTEMBER, 29))
