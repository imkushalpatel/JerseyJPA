...
@NotNull
@Pattern(regexp = "(any|isbn|title|author|publisher.code|publisher.name)") // Not
																			// possible
																			// to
																			// get
																			// regexp
...
public @interface SearchType {
	...
	enum Type {
		...
		ISBN("isbn"), TITLE("title"), AUTHOR("author"), SUMMARY("summary"), PUBLISHER_CODE(
				"publisher.code"), PUBLISHER_NAME("publisher.name");
