...
public class BookRepositoryJpa {
	...
	public List<Book> findBooksBySearchType(final SearchType.Type searchType, final String searchValue,
		...
		return RepositoryJPA.findWithQuery(createQuery(jpql, Book.class, (qp != null ? qp.parameters() : null)), offset,
				limit);
	}
	...
	private <T> TypedQuery<T> createQuery(final String queryString, final Class<T> entityClass,
