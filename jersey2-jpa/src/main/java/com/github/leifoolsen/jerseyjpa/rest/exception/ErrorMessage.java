...
public class ErrorMessage {
	 ...
	 *
	 * @param status
	 *            The HTTP Status errorCode that should be returned by the
	 *            server. <br />
	 *            See {@link <a href=
	 *            "http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10">HTTP/1.1
	 *            documentation</a>} for list of status codes. Additional status
	 *            codes can be added by applications by creating an
	 *            implementation of
	...
	/**
	 * @return The HTTP Status errorCode that should be returned by the server.
	 *         <br />
	 *         See {@link <a href=
	 *         "http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10">HTTP/1.1
	 *         documentation</a>} for list of status codes. Additional status
	 *         codes can be added by applications by creating an implementation
	 *         of {@link javax.ws.rs.core.Response.StatusType}.
	 */
	...
	/*
	 * @return a JSON formatted representation of the error message public
	 * String toJSON() { return JaxbHelper.marshal(this, false); }
	 */

	/**
	 * @return a JSON formatted, pretty print, representation of the error
	 *         message
	 */
	@Override
	public String toString() {
		try {
			...
			return "Marshalling failed with message: " + e.getMessage() + "Fallback {" + "id='" + id + '\''
					+ ", responseStatusCode=" + responseStatusCode + ", message='" + message + '\'' + '}';
		}
	}
	 ...
	 * 
	 * @return ErrorMessage instance public static ErrorMessage fromJSON(final
	 * String jsonString) { return JaxbHelper.unMarshal(ErrorMessage.class,
	 * jsonString); }
	 */
	...
	public static class Builder {
		...
		private Builder(Throwable t, UriInfo uriInfo) {
			...
			// Look for constraint violations in this exceptionClass or in
			...
			ConstraintViolationException cve = t instanceof ConstraintViolationException
					...
					: t.getCause() instanceof ConstraintViolationException ? (ConstraintViolationException) t.getCause()
							: null;
		...
		private static List<ConstraintViolationMessage> createConstraintViolationMessages(
			...
			if (constraintViolations != null) {
				for (ConstraintViolation<?> constraintViolation : constraintViolations) {
					result.add(new ConstraintViolationMessage(constraintViolation.getMessage(),
							constraintViolation.getMessageTemplate(), constraintViolation.getPropertyPath(),
