...
@Provider // => Automatically discovered by the JAX-RS runtime during a provider
			// scanning phase.

// interceptor will be executed only when resource methods
// annotated with @Compress annotation will be executed
// @Compress
// Since the client controls whether the response should be compressed, we omit
// the name binding annotation
public class GZIPWriterInterceptor implements WriterInterceptor {
	...
	public void aroundWriteTo(WriterInterceptorContext context) throws IOException, WebApplicationException {
		...
		List<String> acceptEncoding = MoreObjects.firstNonNull(requestHeaders.get(HttpHeaders.ACCEPT_ENCODING),
