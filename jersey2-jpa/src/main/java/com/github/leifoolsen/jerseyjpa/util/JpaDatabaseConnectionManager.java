...
public class JpaDatabaseConnectionManager {
	...
	/**
	 * <p>
	 * Create an EntityManagerProvider for the named persistence unit.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Close an EntityManagerProvider for the named persistence unit.
	 * </p>
	 *
	 * @param persistenceUnitName
	 *            The name of the persistence unit to remove
	 *
	 */
	...
	/**
	 * <p>
	 * A generic facade that provides easy access to a JPA persistence unit
	 ...
	 * See:
	 * http://naildrivin5.com/blog/2008/05/14/using-threadlocal-and-servlet-filters-to-cleanly-access-jpa-an-entitymanager.html
	 * </p>
	 */
	...
	public static class JpaDatabaseConnection implements UnitOfWork, Provider<EntityManager> {
		 ...
		 * </p>
		 * <p>
		 * This method can be called as many times as needed per thread, and it
		 * will return the same EntityManager instance, until the manager is
		 * closed.
		 * </p>
		 *
