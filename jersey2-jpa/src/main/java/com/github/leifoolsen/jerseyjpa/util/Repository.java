...
public interface Repository {
	...
	<T> TypedQuery<T> createQuery(String jpql, Class<T> resultClass, Map<String, Object> parameters);

	<T> TypedQuery<T> createNamedQuery(String queryName, Class<T> resultClass, Map<String, Object> parameters);
