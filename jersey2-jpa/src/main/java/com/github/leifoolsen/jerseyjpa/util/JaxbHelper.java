...
public class JaxbHelper {
	...
	public static <T> String marshal(final T entity, boolean prettyPrint) {
		...
		try {
			...
			throw new IllegalArgumentException(
					"Failed to marshal entity: " + entity.getClass().getSimpleName() + ". Message: " + t.getMessage(),
					t);
		}
	}
	...
	public static <T> T unMarshal(final Class<T> entityClass, final JsonObject jsonObject) {
		...
		try {
			...
			throw new IllegalArgumentException(
					"Failed to unmarshall entity: " + entityClass.getSimpleName() + ". Message: " + t.getMessage(), t);
		}
	}
