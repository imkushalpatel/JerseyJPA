...
public class JsonMarshalUnMarshalTest {
	...
	private static Book createBook() {
		...
		return Book.with("9780752495620").title("Guide to Middle Earth: Tolkien and The Lord of the Rings")
				.author("Duriez, Colin").publisher(publisher).published(LocalDate.of(2013, Month.JANUARY, 1))
	...
	private static JsonObject createBookAsJsonObject() {
		...
		JsonReader reader = Json.createReader(new StringReader(("{'id':'a38a61e8-38d1-48fa-aa87-356437655647', "
		...
		return factory.createObjectBuilder().add("id", "8343e028-1380-4822-8a29-55a2308f2b29").add("version", 0L)
				.add("isbn", "9780752495620").add("title", "Guide to Middle Earth: Tolkien and The Lord of the Rings")
				.add("published", "2013-01-01").add("author", "Duriez, Colin").add("publisher", publisherAsJsonObject)
				.add("summary", "An illuminating guide to Middle-earth and the man who created it.").build();
