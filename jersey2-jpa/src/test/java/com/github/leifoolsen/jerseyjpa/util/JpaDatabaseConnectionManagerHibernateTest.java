...
public class JpaDatabaseConnectionManagerHibernateTest {
	...
	public static void beforeClass() {
		...
		// Configure PU //
		Properties properties = PersistenceProperties.createPropertiesForProvider(PersistenceProperties.HIBERNATE,
				overridingProperties, Arrays.asList(Publisher.class, Book.class));
