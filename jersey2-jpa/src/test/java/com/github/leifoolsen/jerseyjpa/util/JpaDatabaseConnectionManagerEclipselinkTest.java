...
public class JpaDatabaseConnectionManagerEclipselinkTest {
	...
	public static void beforeClass() {
		// Configure PU //
		Properties properties = PersistenceProperties.createPropertiesForProvider(PersistenceProperties.ECLIPSELINK,
				null, Arrays.asList(Publisher.class, Book.class));
